...
export const crmCases = [
  {
    type: 'Caso de éxito',
    title:
      'Cardif: Crecimiento de Ecosistemas Digitales con Research, Growth, Analytics, CRM y UX/UI',
    description:
      'Entérate cómo Cardif logró, de la mano de Neo, generar más registros en su ecosistema de beneficios digitales a través de experimentación e investigación continúa.',
    img: cardifDesktop,
