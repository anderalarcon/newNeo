export const whySolFullService = {
...
export const whySolAccelerator = {
  title: '¿Por qué elegir esta solución?',
  desc: 'Situaciones y necesidades que podemos resolver con nuestro expertise y metodología',
  reasons: [
...
export const whySolQuickStart = {
  title: '¿Por qué elegir esta solución?',
  desc: 'Situaciones y necesidades que podemos resolver con nuestro expertise y metodología',
  reasons: [
    'Necesitas un roadmap para configurar y potenciar las funcionalidades del CRM de marketing o comercial.',
    'Quieres mejorar aspectos puntuales relacionados con la productividad comercial y la comunicación con los clientes.',
    'Quieres aprovechar la base de datos actual para desarrollar estrategias de comunicación, retención, fidelización y reactivación.'
  ]
}
