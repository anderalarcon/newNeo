...
import { dataHeroAdvancedAnalytics } from '../../../../../utilities/services/aaia/hero'
import { whySolAdvancedAnalytics } from '../../../../../utilities/services/aaia/whySolutions'
import { perksAdvancedAnalytics } from '../../../../../utilities/services/aaia/perks'
import { workAdvancedAnalytics } from '../../../../../utilities/services/aaia/workProcess'
...
const advancedAnalytics = () => {
  ...
  return (
    <>
    <Head>
      <title>Digital Advanced Analytics | Expertos en IA | NEO</title>
      <meta
        name="description"
        content="Obtén la visibilidad del journey 360. Permite explotar las capacidades de las herramientas de analítica digital."
      />
      <meta
      property="og:title"
      content="Digital Advanced Analytics | Expertos en IA | NEO"
      />
