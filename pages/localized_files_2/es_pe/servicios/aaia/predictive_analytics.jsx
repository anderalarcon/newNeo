...
const predictiveAnalytics = () => {
  ...
  return (
    <>
    <Head>
      <title>Predictive Customer Analytics | Expertos en IA | NEO</title>
      <meta
        name="description"
        content="Conoce mejor a tus clientes. Analizamos el comportamiento de los clientes para la toma de decisiones comerciales mediante técnicas predictivas y de segmentación de mercado."
      />
      <meta
      property="og:title"
      content="Predictive Customer Analytics | Expertos en IA | NEO"
      />
