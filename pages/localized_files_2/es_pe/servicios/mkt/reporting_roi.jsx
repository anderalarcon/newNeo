...
const reportingRoi = () => {
  ...
  return (
    ...
    <Head>
      <title>
        Reporting ROI Automatizado | Campañas de publicidad digital | Neo Consulting
      </title>
      <meta
        name="keywords"
      ...
      <meta
        name="description"
        content="Evalúa el rendimiento de tus campañas de adquisición pagadas en tiempo real. Documenta aprendizajes y toma medidas para acelerar tu ROI."
      />
      <meta
      property="og:title"
      content="Reporting ROI Automatizado | Campañas de publicidad digital | Neo Consulting"
      />
