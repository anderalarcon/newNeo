...
import { HerramientasAIDescargable } from '../../../utilities/landings_next/ContentTyDescargables/TyDescargables'

const HerramientasAIDescargableThanks = () => {
  return (
    <>
      <Head>
      ...
      <Header />
      <ContentTyDescargables data={HerramientasAIDescargable} />
      <Footer />
    </>
  )
}

export default HerramientasAIDescargableThanks
