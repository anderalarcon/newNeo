...
import { ChatbotsDescargable } from '../../../utilities/landings_next/ContentTyDescargables/TyDescargables'

const ChatbotsDescargableThanks = () => {
  return (
    <>
      <Head>
      ...
      <Header />
      <ContentTyDescargables data={ChatbotsDescargable} />
      <Footer />
    </>
  )
}

export default ChatbotsDescargableThanks
