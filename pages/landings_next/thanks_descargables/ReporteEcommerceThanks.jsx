...
import { ReporteEcommerceDescargable } from '../../../utilities/landings_next/ContentTyDescargables/TyDescargables'
...
const ReporteEcommerceThanks = () => {
  return (
    <>
      ...
      <Header />
      <ContentTyDescargables data={ReporteEcommerceDescargable} />
      <Footer />
    </>
  )
}
