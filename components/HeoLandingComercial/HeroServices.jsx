    ...
    return (
      <>
        <a className={style.hero_container_left_ctn_services} href='#form'>
          <button>Quiero optimizar mi estrategia</button>
        </a>
        {/* <Link
      ...
      <div className={style.hero_container}>
        ...
        <div className={style.hero_container_right}>
          <div className={style.hero_container_right_img}>
            <img className={style.hero_container_right_img_main} src={mainImg} alt={solution} />
            <img className={style.hero_container_right_img_rotative1} src={rotative1} />
            <img className={style.hero_container_right_img_rotative2} src={rotative2} />
            <img className={style.hero_container_right_img_rotative3} src={rotative3} />
          </div>
        </div>
