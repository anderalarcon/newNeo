...
import heropacasmayo from '../../../public/assets/CasosDeExito/Abbott/hero_abbott.png'
      ...
      <div className={style.hero_container}>
        <div className={style.hero_container_left}>
          ...
          <h1 className={style.hero_container_left_titulo}>
            Medición de las capacidades Ecommerce de un laboratorio farmaceútico
          </h1>
          <a href="https://www.neoconsulting.ai/hubfs/Casos%20de%20%C3%89xito/CDE%20Ecommerce%20Maturity%20Assessment.pdf" target='_blank' className={style.hero_container_left_a} rel="noreferrer">
        ...
        <div className={style.hero_container_right}>
          <img className={style.hero_container_right_img}
            src={heropacasmayo.src} alt="hero" />
        </div>
      </div>
    </div>
  )
